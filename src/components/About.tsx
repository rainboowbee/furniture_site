      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="mt-4 text-white/80 leading-relaxed">
              Наша команда объединяет опытных мастеров, которые создают мебель с учетом особенностей вашего пространства. Мы используем только качественные материалы: устойчивую к погодным условиям качественную древесину, прочный металл и водоотталкивающие ткани.
            </p>
            <p className="mt-4 text-white/80 leading-relaxed">
