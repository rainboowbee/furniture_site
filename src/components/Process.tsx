  ...
  const steps = [
    {
      ...
      items: ["Коммерческое предложение", "Техническое задание", "Подписание договора"],
      icon: "🌱",
    ...
    },
    {
      ...
      items: ["Обмеры и анализ участка", "Разработка эскизов проекта", "Подбор материалов", "Создание чертежей"],
      icon: "✏️",
